...
import { generarPDFProyectos } from '../../hooks/pdfGenerator'
...
const ProyectosView = () => {
  ...
  const generarPDFProyectosHandler = () => {
    generarPDFProyectos(proyectosFiltrados, stats, todasLasTareas, filtroEstado)
  }
    ...
    <div className="ads-root">
      ...
      <div className="ads-toolbar">
        ...
        <button
          ...
          onClick={generarPDFProyectosHandler}
        >
          📄 Generar Reporte
        </button>
      </div>
